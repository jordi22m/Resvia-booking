-- =============================================================================
-- Hotfix: restore booking.confirmed emission for create_public_booking_v2
-- Root cause: function inserted appointment as pending and never transitioned
-- status to confirmed, so update trigger never emitted booking.confirmed.
-- =============================================================================
...
BEGIN
  ...
  -- Este UPDATE dispara el trigger de appointments para emitir booking.confirmed
