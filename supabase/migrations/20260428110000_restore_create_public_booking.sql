-- =============================================================================
-- Restore create_public_booking function
-- Safe: uses CREATE OR REPLACE only (no DROP). Can be applied even if
-- the function is missing or already exists.
-- =============================================================================
...
BEGIN
  ...
  -- Finalize booking: UPDATE triggers booking.confirmed webhook via trigger.
